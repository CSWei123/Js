class showInventory extends Phaser.Scene {
   ...
   create () {
       ...
       this.heartimg1 = this.add.image (100,43,'heart').setScrollFactor(0).setVisible(false).setScale(0.2);
       this.heartimg2 = this.add.image (170,43,'heart').setScrollFactor(0).setVisible(false).setScale(0.2);
       this.heartimg3 = this.add.image (240,43,'heart').setScrollFactor(0).setVisible(false).setScale(0.2);
